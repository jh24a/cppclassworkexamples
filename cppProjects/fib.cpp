...
int main(){
	...
	//attempt at doing fib function as refresher 
	//for c++
...
uintmax_t fib(unsigned int n){
	...
	*/
	...
	//interative 
	//unsigned int prev1 = 1,prev2 = 1,curr = 1; // runs fine at 47 iterations. after around 48? iterations it does what i think is bit overflow because it starts returning wrong or negative inteegers. So im trying to increase the variable size but it still doesnt work.
...
//what is the next possible solution to reach higher iterations?
